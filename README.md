...
- The single non-zero T = 0 cell is `mcp x centralized` (FC2 = 0.23 across 13 valid
  trials, replicated across two worker models: gpt-4.1-mini and gpt-4o). Confirmed
  by trace inspection: the orchestrator wraps its own integration step in MCP envelopes
